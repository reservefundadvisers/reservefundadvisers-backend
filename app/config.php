...
$db_table_cols = [ 
                    ...
                    $aiDocumentsTable => ['row_id', 'id', 'user_id', 'pdf_path', 'assistant_id', 'thread_id', 'run_id', 'openai_file_id', 'extracted_json','run_payload', 'error_message', 'created_at', 'completed_at', 'status','admin_approval_status'],
                ];
