...
$db_table_cols = [ 
                    ...
                    $clientsTable => ['id', 'association', 'company', 'company_id', 'type', 'company_type', 'email', 'phone', 'address', 'address2', 'city', 'zip', 'state', 'active', 'created_at'],
                    $clientPositionsTable => ['row', 'id', 'value', 'client_id'], 
                    $modelsTable => ['row', 'id', 'name', 'client_id', 'housing', 'starting_amount', 'inflation_rate', 'monthly_fees', 'monthly_fees_rate', 'cushion_fund', 'period', 'bank_int_rate', 'bank_rate', 'loan_years', 'fiscal_year', 'inv_strategy', 'active', 'updated_at', 'created_at'],
                    $modelItemsTable => ['row', 'id', 'parent_id', 'model_id', 'name', 'redundancy', 'remaining_life', 'cost', 'is_sirs'],
