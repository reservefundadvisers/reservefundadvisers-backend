...
$lang['en']['auth']['login_auth_sent'] = "Your login Validation Code has been sent !";
$lang['en']['auth']['login_auth_validated'] = "Your login has been validated !";
$lang['en']['auth']['login_auth_already'] = "Your login has already been validated !";
$lang['en']['auth']['login_auth_code_empty'] = "Invalid Validation Code !";
$lang['en']['auth']['login_auth_code_incorrect'] = "Incorrect Validation Code !";
$lang['en']['auth']['login_auth_code_expired'] = "Your Validation Code has expired, a new one has been sent to you !";
$lang['en']['auth']['login_auth_email_empty'] = "Invalid E-mail to send Validation Code to, please contact the administrator !";

$lang['en']['auth']['login_not_admin'] = "You are not an administrator !";
...
$lang['en']['auth']['register_password_exist'] = "Username is already in use !";
...
$lang['fr']['auth']['changeinfos_success'] = "Infos successfully changed !";

$lang['en']['auth']['resetpass_lockedout'] = "You have been temporarily locked out !";
$lang['en']['auth']['resetpass_wait30'] = "Please wait 30 mins.";
$lang['en']['auth']['resetpass_username_empty'] = "Username field is empty !";
$lang['en']['auth']['resetpass_username_short'] = "Username is too short !";
$lang['en']['auth']['resetpass_username_long'] = "Username is too long !";
$lang['en']['auth']['resetpass_username_invalid'] = "Username is invalid !";
$lang['en']['auth']['resetpass_username_incorrect'] = "Username is incorrect !";
...
$lang['en']['auth']['resetpass_newpass_empty'] = "Password field is empty !";
$lang['en']['auth']['resetpass_newpass_short'] = "Password must be at least 6 characters !";
$lang['en']['auth']['resetpass_newpass_long'] = "Password is too long !";
$lang['en']['auth']['resetpass_newpass_username'] = "Password cannot contain username !";
...
$lang['en']['auth']['resetpass_info_incorrect'] = "Information entered are incorrect !";
...
$lang['en']['auth']['signup_error'] = "Error while Signing up !";
$lang['en']['auth']['signup_success'] = "Sign up successfully !";
$lang['en']['auth']['signup_order_error'] = "Invalid Order ID !";
$lang['en']['auth']['signup_subscription_error'] = "Please choose a subscription !";
$lang['en']['auth']['signup_payment_error'] = "Error while generating payment !";
$lang['en']['auth']['signup_assoc_error'] = "Please enter a valid Association Name !";
$lang['en']['auth']['signup_company_error'] = "Please enter a valid Company Name !";
$lang['en']['auth']['signup_email_error'] = "Please enter a valid Email !";
$lang['en']['auth']['signup_email_exists'] = "This Email already exists !";
$lang['en']['auth']['signup_password_error'] = "Please enter a valid Password, Should be at least 6 characters long ";
$lang['en']['auth']['signup_fn_error'] = "Please enter a valid First Name !";
$lang['en']['auth']['signup_ln_error'] = "Please enter a valid Last Name !";
$lang['en']['auth']['signup_phone_error'] = "Please enter a valid Phone Number !";
$lang['en']['auth']['signup_otp_validated'] = "The OTP validated successfully !";
$lang['en']['auth']['signup_otp_error'] = "Please enter a valid OTP Code !";
$lang['en']['auth']['signup_otp_invalid'] = "The OTP Code is invalid !";
...
$lang['en']['auth']['signup_mobile_exists'] = "Mobile Number is already in use !";
$lang['en']['auth']['signup_position_error'] = "Please enter a valid Position ID !";
...
$lang['fr']['auth']['login_username_empty'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_username_short'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_username_long'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_password_empty'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_password_short'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_password_long'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_incorrect'] = "Mot de passe incorrect !";
$lang['fr']['auth']['login_attempts_remaining'] = "%d tentatives restantes !";
$lang['fr']['auth']['login_account_inactive'] = "Compte désactivé !";
$lang['fr']['auth']['login_success'] = "Vous etes maintenant connecté !";
$lang['fr']['auth']['login_already'] = "Vous etes deja connecté !";
$lang['fr']['auth']['login_fail'] = "Vous etes pas connecté !";

$lang['fr']['auth']['login_not_admin'] = "Vous n'êtes pas un administrateur !";
...
$lang['fr']['auth']['register_password_exist'] = "Le  mot de passe est deja pris !";
...
$lang['fr']['auth']['changeinfos_success'] = "Infos modifiés avec succès !";
