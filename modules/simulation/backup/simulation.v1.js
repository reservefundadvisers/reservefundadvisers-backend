...
var Simulation = function(){
    ...
    Simulation.prototype.eraseDeficit = function(at, amount = 0, yearlyCollections = 0, units = 1, original_spendings_amount = 0, total_amount = 0, cb){
        ...
        var monthly_fees_slider = deficit_box.find('.monthly-fees-slider'),
            ...
            monthly_fees = yearlyCollections/(12 * this.simulation_data.model.housing);
            ...
            monthly_fees_label.unbind().change(function(){      
                                                            var value = Math.ceil(this.value); if(value < monthly_fees)value = monthly_fees;
                                                            ...
                                                            monthly_fee_increase_update_value(r);
                                                        });
        ...
        deficit_box.find('.apply').click(function(){
                ...
                utils.deficit(context.model_id, {"year": at, "splits":tmp, "deficit":deficit_data, "unsplit":spendings_unsplit}, 
                            function(resp){
                                deficit_modal.close();
                                execfunc(cb);
                            })
            ...
            this.simulation(model_id, function(data){
                ...
                var formatter = function(row){
                    ...
                    for(var c of cells){
                        ...
                        if(k == "loan_pi" ){ if( value > 0) { cell.addClass('w3-purple'); } else{ formattedValue = ""; } }
                        ...
                        else if(k == 'rfa' && value < 0){ cell.addClass('w3-red');}
                            ...
                            /*
                            cell.addClass('w3-purple erase-deficit').data('at', i).data('amount', Math.abs(data.fa)).data('yc', Math.abs(data.yc)).data('sp', Math.abs(data.sp))
                                        .click(function(){ context.eraseDeficit($(this).data('at'), $(this).data('amount'), $(this).data('yc'), context.simulation_data.model.housing, $(this).data('sp'), function(){ context.init(); }); });

                                        formattedValue = "Erase Deficit ?"; 
