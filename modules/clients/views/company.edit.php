<div class="modal fade" id="<?=$arand;?>_modal" data-backdrop="false" data-keyboard="false" style="background:rgba(0,0,0,0.2)" tabindex="-1" role="dialog" aria-labelledby="editorModalLabel" aria-hidden="true"> 
        ...
        <div class="modal-content shadow"> 
            ...
            <h5 class="modal-title" style="font-size:20px;" qompta-tr="user">Management Company</h5> 
            ...
            <div class="modal-body pt-0">  
                ...
                <div  class="form-row mt-2"> 
                    ...
                    <div class="col-12">
                        <input type="text" class="app-input editor-input" data-key="company" data-field="Name" pattern="[A-Za-z0-9\s]+" data-helper="Use Alphanumrical Only (A-Z 0-9)" data-invalid="Association Name invalid: Use Alphanumrical Only (A-Z 0-9)"  required/>
                    </div>  
