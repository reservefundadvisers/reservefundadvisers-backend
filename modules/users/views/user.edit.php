<div class="modal fade" id="<?=$arand;?>_modal" data-backdrop="false" data-keyboard="false" style="background:rgba(0,0,0,0.2)" tabindex="-1" role="dialog" aria-labelledby="editorModalLabel" aria-hidden="true"> 
        ...
        <div class="modal-content shadow"> 
            ...
            <h5 class="modal-title" style="font-size:20px;" qompta-tr="user">Assistant</h5> 
                ...
                <div  class="form-row mt-2"> 
                    ...
                    <div class="col-sm-6">
                        <?php 
                            ...
                            if($auth->uid() != check_val($vars, 'id')){

                                echo '
                                
                                    <select class="app-input editor-input" data-key="role" data-field="Role" data-invalid="Role invalid !"  required>
