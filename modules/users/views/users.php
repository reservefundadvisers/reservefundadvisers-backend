<div class="modal fade <?=$arand;?>_users" id="<?=$arand;?>_modal" data-backdrop="false" data-keyboard="false" style="background:rgba(0,0,0,0.2)" tabindex="-1" role="dialog" aria-labelledby="editorModalLabel" aria-hidden="true"> 
        <div class="modal-dialog" role="document" style="height:94vh; width:95%; max-width:1200px"> 
            <div class="modal-content shadow" style="height:100%"> 
                ...
                <h5 class="modal-title" style="font-size:20px;" qompta-tr="user">Assistants (<span class="<?=$arand;?>_users_count">0</span>)</h5> 
                ...
                <div class="modal-body pt-0">  
                    ...
                    <div class="w-100 d-flex flex-row py-2">
                        ...
                        <div class="mr-auto">
                            <button class="btn btn-sm btn-danger shadow-sm" data-role="admin,manager" onclick="<?=$arand;?>_users.delete()"><i
                                    class="fas  fa-trash btn-icon text-white" ></i> <span class="btn-text" >Delete Selection</span> <i class="ml-1"></i>(<b><span class=" <?=$arand;?>_users_select_count" data-zero="empty">0</span></b>)</button>
                          
                        </div>
                              
                        
                        <label onclick="<?=$arand;?>_users.edit()" class="btn btn-sm btn-primary"><i class="fa fa-plus ml-1"></i> New</label>        
                    ...
                    <div class="table-responsive" style="min-height:300px;">
                        <table class="table-primary <?=$arand;?>_users_table invisible start-toggled" cellspacing="0" id="" style="">
                            <thead>
                                <tr>
                                    <th data-role="admin"     
                                    ...
                                    <th data-role="admin" tabulator-field="action" tabulator-headerSort="false" tabulator-hozAlign="center" tabulator-headerHozAlign="Center" tabulator-frozen="true" tabulator-minWidth="50" tabulator-maxWidth="50">...</th>
                                    ...
                                    <th tabulator-field="username" tabulator-headerFilter="input" tabulator-headerFilterLiveFilter="false" tabulator-minWidth="160" >Username</th>
                ...
                <script>
                    var <?=$arand;?>_users;
                    setTimeout(() => {
                        <?=$arand;?>_users = init_users('.<?=$arand;?>_users');    
                    }, 200);
